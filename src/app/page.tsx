          ...
          <AnimatePresence mode="popLayout">
            {filteredPackages.map((pkg, i) => (
              <motion.div
                ...
                className={`relative rounded-2xl overflow-hidden flex flex-col ${mostPopularPackageIds.includes(pkg.id)
              ...
              >
                ...
                <div className="p-7 flex flex-col h-full">
                  {/* Icon */}
                  <div className={`w-12 h-12 rounded-xl flex items-center justify-center mb-5 ${mostPopularPackageIds.includes(pkg.id) ? "bg-gradient-to-br from-[#D4AF37] to-[#AA8529] text-white shadow-lg shadow-[#D4AF37]/30" : "bg-[var(--primary-glow)] text-[var(--primary)]"
                    }`}>
                  ...
                  <Link href={`/builder?package=${encodeURIComponent(pkg.name)}`}>
                    <div className={`w-full py-4 rounded-xl font-bold transition-all text-sm flex items-center justify-center gap-2 ${mostPopularPackageIds.includes(pkg.id)
